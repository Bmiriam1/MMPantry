...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.Holder>{
 ...
 public void onBindViewHolder(Holder h,int pos){
  ...
  String status = (r.missingIngredient != null)
          ? "Missing: " + r.missingIngredient
          : r.ingredients.size()+"/"+r.ingredients.size()+" pantry ingredients";
  h.button.setText(r.name+"\n"+r.description+"\n"+status+"  •  "+r.prepTime+" min");
  h.button.setOnClickListener(v->listener.open(r));
 }
